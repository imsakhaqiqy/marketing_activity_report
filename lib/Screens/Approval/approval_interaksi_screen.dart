...
import 'package:kreditpensiun_apps/Screens/Approval/approval_interaksi_view_screen.dart';
...
class ApprovalInteractionScreen extends StatefulWidget {
  ...
  ApprovalInteractionScreen(
      this.username, this.nik, this.hakAkses, this.nikSdm);
}
    ...
    return SafeArea(
      child: Scaffold(
        ...
        body: RefreshIndicator(
            onRefresh: () => Provider.of<ApprovalInteractionProvider>(context,
                    listen: false)
            ...
            child: Container(
              ...
              child: FutureBuilder(
                future: Provider.of<ApprovalInteractionProvider>(context,
                        listen: false)
                    .getApprovalInteraction(
                        ApprovalInteractionItem(widget.nikSdm)),
                            ...
                            Expanded(
                              child: ListView.builder(
                                ...
                                itemBuilder: (context, i) {
                                  String nama;
                                  if (data.dataApprovalInteraction[i].namaSales
                                          .length >
                                      15) {
                                    nama = data
                                        .dataApprovalInteraction[i].namaSales
                                        .substring(0, 15);
                                  } else {
                                    nama = data
                                        .dataApprovalInteraction[i].namaSales;
                                  ...
                                  String debitur;
                                  if (data.dataApprovalInteraction[i]
                                          .calonDebitur.length >
                                      15) {
                                    debitur = data
                                        .dataApprovalInteraction[i].calonDebitur
                                        .substring(0, 15);
                                  } else {
                                    debitur = data.dataApprovalInteraction[i]
                                        .calonDebitur;
                                  }
                                  return Card(
                                    elevation: 4,
