        ...
        child: Scaffold(
          ...
          body: TabBarView(children: <Widget>[
            Container(
              ...
              child: FutureBuilder(
                future: Provider.of<ApprovalDisbursmentProvider>(context,
                        listen: false)
                    .getApprovalDisbursment(
                        ApprovalDisbursmentItem(widget.nikSdm)),
                          ...
                          children: <Widget>[
                            Expanded(
                              child: ListView.builder(
                                  ...
                                  itemCount:
                                      data.dataApprovalDisbursment.length,
                                  itemBuilder: (context, i) {
                                    String namaSales;
                                    if (data.dataApprovalDisbursment[i]
                                            .namaSales.length >
                                        15) {
                                      namaSales = data
                                          .dataApprovalDisbursment[i].namaSales
                                          .substring(0, 15);
                                    } else {
                                      namaSales = namaSales = data
                                          .dataApprovalDisbursment[i].namaSales;
                                    }
                                    String debitur;
                                    if (data.dataApprovalDisbursment[i].debitur
                                            .length >
                                        15) {
                                      debitur = data
            ...
            Container(
              padding: EdgeInsets.symmetric(horizontal: 18.0),
              child: FutureBuilder(
                future: Provider.of<ApprovalDisbursmentAgenProvider>(context,
                        listen: false)
                    .getApprovalDisbursmentAgen(
                        ApprovalDisbursmentAgenItem(widget.nikSdm)),
                builder: (context, snapshot) {
                  if (snapshot.connectionState == ConnectionState.waiting) {
                    return Center(
                      child: CircularProgressIndicator(
                          ...
                          children: <Widget>[
                            Expanded(
                              child: ListView.builder(
                                  scrollDirection: Axis.vertical,
                                  itemCount:
                                      data.dataApprovalDisbursmentAgen.length,
                                  itemBuilder: (context, i) {
                                    String namaSales;
                                    if (data.dataApprovalDisbursmentAgen[i]
                                            .namaSales.length >
                                        15) {
                                      namaSales = data
