import 'package:kreditpensiun_apps/Screens/models/disbursment_akad_model.dart';
...
class DisbursmentAkadProvider extends ChangeNotifier {
  ...
  Future<List<DisbursmentAkadModel>> getDisbursmentAkad(
    ...
    if (response.statusCode == 200) {
      final result = json
          .decode(response.body)['Daftar_Disbursment_Akad']
          .cast<Map<String, dynamic>>();
      _data = result
          .map<DisbursmentAkadModel>(
              (json) => DisbursmentAkadModel.fromJson(json))
          .toList();
      return _data;
    } else {
      throw Exception();
