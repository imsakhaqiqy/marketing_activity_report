import 'package:kreditpensiun_apps/Screens/models/filter_report_disbursment_model.dart';
...
class FilterReportDisbursmentSlProvider extends ChangeNotifier {
  ...
  Future<List<FilterReportDisbursmentModel>> getDisbursmentFilterSlReport(
    ...
    final url =
        'https://www.nabasa.co.id/api_marsit_v1/index.php/getDisbursmentReportSlFilter';
    ...
    if (response.statusCode == 200) {
      ...
      _data = result
          .map<FilterReportDisbursmentModel>(
              (json) => FilterReportDisbursmentModel.fromJson(json))
          .toList();
      return _data;
    } else {
      throw Exception();
