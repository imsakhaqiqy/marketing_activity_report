import 'package:kreditpensiun_apps/Screens/models/simulation_kp74_model.dart';
...
class SimulationKp74Provider extends ChangeNotifier {
  ...
  Future<List<SimulationKp74Model>> getSimulationKp74(
      simulationKp74Item simulationkp74) async {
    String url =
        'https://www.nabasa.co.id/api_marsit_v1/index.php/getSimulationKp74';
    ...
    if (response.statusCode == 200) {
      final result = json
          .decode(response.body)['Daftar_Simulasi_Kp74']
          .cast<Map<String, dynamic>>();
      _data = result
          .map<SimulationKp74Model>(
              (json) => SimulationKp74Model.fromJson(json))
          .toList();
      return _data;
      print(result);
    } else {
