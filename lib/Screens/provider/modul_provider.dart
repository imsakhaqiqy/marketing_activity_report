import 'package:kreditpensiun_apps/Screens/models/modul_model.dart';
...
class ModulProvider extends ChangeNotifier {
  ...
  Future<List<ModulModel>> getModul() async {
    ...
    if (response.statusCode == 200) {
      final result = json
          .decode(response.body)['Daftar_Modul']
          .cast<Map<String, dynamic>>();
      _data =
          result.map<ModulModel>((json) => ModulModel.fromJson(json)).toList();
      return _data;
    } else {
      throw Exception();
    }
