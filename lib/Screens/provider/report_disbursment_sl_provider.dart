import 'package:kreditpensiun_apps/Screens/models/report_disbursment_model.dart';
...
class ReportDisbursmentSlProvider extends ChangeNotifier {
  ...
  Future<List<ReportDisbursmentModel>> getDisbursmentSlReport(
    ...
    final url =
        'https://www.nabasa.co.id/api_marsit_v1/index.php/getDisbursmentSlReport';
    ...
    if (response.statusCode == 200) {
      final result = json
          .decode(response.body)['Daftar_Report_Disbursment_Sl']
