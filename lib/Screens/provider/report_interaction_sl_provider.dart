import 'package:kreditpensiun_apps/Screens/models/report_interaction_model.dart';
...
class ReportInteractionSlProvider extends ChangeNotifier {
  ...
  Future<List<ReportInteractionModel>> getInteractionSlReport(
    ...
    final url =
        'https://www.nabasa.co.id/api_marsit_v1/index.php/getInteractionSlReport';
    ...
    if (response.statusCode == 200) {
      final result = json
          .decode(response.body)['Daftar_Report_Interaction_Sl']
          .cast<Map<String, dynamic>>();
      _data = result
          .map<ReportInteractionModel>(
              (json) => ReportInteractionModel.fromJson(json))
          .toList();
      return _data;
    } else {
      throw Exception();
