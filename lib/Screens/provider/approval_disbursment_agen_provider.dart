import 'package:kreditpensiun_apps/Screens/models/approval_disbursment_agen_model.dart';
...
class ApprovalDisbursmentAgenProvider extends ChangeNotifier {
  ...
  Future<List<ApprovalDisbursmentAgenModel>> getApprovalDisbursmentAgen(
    ...
    final url =
        'https://www.nabasa.co.id/api_marsit_v1/index.php/getApprovalDisbursmentAgen';
    final response = await http
        .post(url, body: {'nik_sales': approvalDisbursmentAgenItem.nik});
