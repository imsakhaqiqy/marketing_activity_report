import 'package:kreditpensiun_apps/Screens/models/interaction_model.dart';
...
class InteractionProvider extends ChangeNotifier {
  ...
  Future<List<InteractionModel>> getInteraction(
    ...
    if (response.statusCode == 200) {
      final result = json
          .decode(response.body)['Daftar_Interaction']
