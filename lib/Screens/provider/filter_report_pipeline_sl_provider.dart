import 'package:kreditpensiun_apps/Screens/models/filter_report_pipeline_model.dart';
...
class FilterReportPipelineSlProvider extends ChangeNotifier {
  ...
  Future<List<FilterReportPipelineModel>> getPipelineFilterSlReport(
    ...
    final url =
        'https://www.nabasa.co.id/api_marsit_v1/index.php/getPipelineReportSlFilter';
    ...
    if (response.statusCode == 200) {
      ...
      _data = result
          .map<FilterReportPipelineModel>(
              (json) => FilterReportPipelineModel.fromJson(json))
          .toList();
      return _data;
    } else {
      throw Exception();
