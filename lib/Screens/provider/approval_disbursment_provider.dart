import 'package:kreditpensiun_apps/Screens/models/approval_disbursment_model.dart';
...
class ApprovalDisbursmentProvider extends ChangeNotifier {
  ...
  Future<List<ApprovalDisbursmentModel>> getApprovalDisbursment(
    ...
    final url =
        'https://www.nabasa.co.id/api_marsit_v1/index.php/getApprovalDisbursment';
    final response =
        await http.post(url, body: {'nik_sales': approvalDisbursmentItem.nik});
    ...
    if (response.statusCode == 200) {
      ...
      if (result != '') {
        _data = result
            .map<ApprovalDisbursmentModel>(
                (json) => ApprovalDisbursmentModel.fromJson(json))
            .toList();
      }
      return _data;
    } else {
