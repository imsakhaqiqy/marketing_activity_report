import 'package:kreditpensiun_apps/Screens/models/filter_report_interaction_model.dart';
...
class FilterReportInteractionSlProvider extends ChangeNotifier {
  ...
  Future<List<FilterReportInteractionModel>> getInteractionFilterSlReport(
    ...
    final url =
        'https://www.nabasa.co.id/api_marsit_v1/index.php/getInteractionReportSlFilter';
    ...
    if (response.statusCode == 200) {
      ...
      _data = result
          .map<FilterReportInteractionModel>(
              (json) => FilterReportInteractionModel.fromJson(json))
          .toList();
      return _data;
    } else {
      throw Exception();
