import 'package:kreditpensiun_apps/Screens/models/approval_interaction_model.dart';
...
class ApprovalInteractionProvider extends ChangeNotifier {
  ...
  Future<List<ApprovalInteractionModel>> getApprovalInteraction(
    ...
    final url =
        'https://www.nabasa.co.id/api_marsit_v1/index.php/getApprovalInteraction';
    final response =
    ...
    if (response.statusCode == 200) {
      final result = json
          .decode(response.body)['Daftar_Approval_Interaction']
          .cast<Map<String, dynamic>>();
      _data = result
          .map<ApprovalInteractionModel>(
              (json) => ApprovalInteractionModel.fromJson(json))
          .toList();
      return _data;
    } else {
      throw Exception();
