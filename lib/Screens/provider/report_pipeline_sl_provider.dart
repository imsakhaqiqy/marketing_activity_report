import 'package:kreditpensiun_apps/Screens/models/report_pipeline_model.dart';
...
class ReportPipelineSlProvider extends ChangeNotifier {
  ...
  Future<List<ReportPipelineModel>> getPipelineSlReport(
    ...
    final url =
        'https://www.nabasa.co.id/api_marsit_v1/index.php/getPipelineSlReport';
    ...
    if (response.statusCode == 200) {
      final result = json
          .decode(response.body)['Daftar_Report_Pipeline_Sl']
          .cast<Map<String, dynamic>>();
      _data = result
          .map<ReportPipelineModel>(
              (json) => ReportPipelineModel.fromJson(json))
          .toList();
      return _data;
    } else {
      throw Exception();
