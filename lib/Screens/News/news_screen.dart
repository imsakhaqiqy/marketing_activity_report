...
import 'package:kreditpensiun_apps/Screens/provider/berita_provider.dart';
import 'package:kreditpensiun_apps/Screens/News/news_view_screen.dart';
    ...
    return SafeArea(
      child: Scaffold(
        ...
        body: RefreshIndicator(
            onRefresh: () =>
                Provider.of<BeritaProvider>(context, listen: false).getBerita(),
            color: Colors.red,
            child: Container(
              margin: EdgeInsets.all(10),
              child: FutureBuilder(
                future: Provider.of<BeritaProvider>(context, listen: false)
                    .getBerita(),
                                          ...
                                          Container(
                                            ...
                                            child: ClipRRect(
                                              ...
                                              child: Image(
                                                ...
                                                image: NetworkImage(
                                                  'https://www.nabasa.co.id/marsit/${data.dataBerita[i].path}',
                                                ),
                                              ),
                                            ),
                                          )
