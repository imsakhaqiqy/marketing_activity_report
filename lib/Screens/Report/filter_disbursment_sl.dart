...
class FilterDisbursmentSlReportScreen extends StatefulWidget {
  @override
  _FilterDisbursmentSlReportScreen createState() =>
      _FilterDisbursmentSlReportScreen();
...
class _FilterDisbursmentSlReportScreen
    extends State<FilterDisbursmentSlReportScreen> {
  @override
    ...
    return SafeArea(
      child: Scaffold(
        ...
        body: RefreshIndicator(
            onRefresh: () => Provider.of<FilterReportDisbursmentSlProvider>(
                    context,
                    listen: false)
                .getDisbursmentFilterSlReport(FilterReportDisbursmentSlItem(
                    widget.nik, widget.tglAwal, widget.tglAkhir)),
            color: Colors.red,
            child: Container(
              child: FutureBuilder(
                future: Provider.of<FilterReportDisbursmentSlProvider>(context,
                        listen: false)
                    .getDisbursmentFilterSlReport(FilterReportDisbursmentSlItem(
                        widget.nik, widget.tglAwal, widget.tglAkhir)),
                    ...
                    builder: (context, data, _) {
                      ...
                      if (data.dataDisbursmentFilterSlReport.length == 0) {
                        ...
                        return GridView.builder(
                            itemCount:
                                data.dataDisbursmentFilterSlReport.length,
                            gridDelegate:
                                SliverGridDelegateWithFixedCrossAxisCount(
                              crossAxisCount: 2,
                            ),
                            itemBuilder: (context, i) {
                              if (data.dataDisbursmentFilterSlReport[i].debitur
                                      .length >
                                  15) {
                                calonDebitur = data
                                    .dataDisbursmentFilterSlReport[i].debitur
                                    .substring(0, 15);
                              } else {
                                calonDebitur = data
                                    .dataDisbursmentFilterSlReport[i].debitur;
                              ...
                              if (data.dataDisbursmentFilterSlReport[i]
                                      .plafond !=
                                  '') {
                                if (data.dataDisbursmentFilterSlReport[i]
                                        .plafond.length >
                                  ...
                                  rencanaPinjaman = data
                                      .dataDisbursmentFilterSlReport[i].plafond
                                      .substring(0, 15);
                                } else {
                                  rencanaPinjaman = data
                                      .dataDisbursmentFilterSlReport[i].plafond;
                                          ...
                                          children: <Widget>[
                                            Stack(
                                              children: <Widget>[
                                                SizedBox(
                                                  child: Image.network(
                                                    'https://www.nabasa.co.id/marsit/${data.dataDisbursmentFilterSlReport[i].foto2}',
                                                    fit: BoxFit.cover,
                                                  ),
                                                  height: 100.0,
