    ...
    return SafeArea(
      child: Scaffold(
        ...
        body: RefreshIndicator(
            onRefresh: () => Provider.of<FilterReportInteractionProvider>(
                    context,
                    listen: false)
                      ...
                      if (data.dataInteractionFilterReport.length == 0) {
                        ...
                        return GridView.builder(
                            ...
                            itemBuilder: (context, i) {
                              if (data.dataInteractionFilterReport[i]
                                      .calonDebitur.length >
                                  15) {
                                calonDebitur = data
                              ...
                              if (data.dataInteractionFilterReport[i].plafond !=
                                ...
                                if (data.dataInteractionFilterReport[i].plafond
                                  ...
                                  rencanaPinjaman = data
                                      .dataInteractionFilterReport[i].plafond;
                                } else {
                                  rencanaPinjaman = data
                                      .dataInteractionFilterReport[i].plafond;
                                }
                              ...
                              if (data.dataInteractionFilterReport[i].alamat !=
                                ...
                                if (data.dataInteractionFilterReport[i].alamat
                                    ...
                                    15) {
                                  alamat = data
                                      .dataInteractionFilterReport[i].alamat;
                                } else {
                                  alamat = data
                                      .dataInteractionFilterReport[i].alamat;
                                }
