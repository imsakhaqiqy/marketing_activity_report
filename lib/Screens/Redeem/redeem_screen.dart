...
class _RedeemScreenState extends State<RedeemScreen> {
  ...
  Future cekPulsa() async {
    ...
    //server login api
    var url = 'https://www.nabasa.co.id/api_marsit_v1/index.php/getPricelist';
    telepon = teleponController.text;
  ...
  Future konfirmasiPulsa(niksales, telepon, hargaBeli, kodeProduk) async {
    ...
    //server save api
    var url = 'https://nabasa.co.id/api_marsit_v1/index.php/konfirmasiPulsa';
                            ...
                            return Container(
                              ...
                              child: Column(
                                children: <Widget>[
                                  ...
                                  namaField(
                                      'Diamond Tersedia',
                                      setNull(widget.diamond.toString() +
                                          ' DIAMOND'),
                                      12.0,
                                      FontWeight.normal),
                                  namaField(
                                      'Voucher ' +
                                          ...
                                          pricelist[i]['provider']
                                              ...
                                              .substring(1)
                                              .toLowerCase(),
                                      setNull(pricelist[i]['code'].toString() +
                                          ',000'),
                                      12.0,
                                      FontWeight.normal),
                                  ...
                                  namaField(
                                      'Harga Voucher',
                                      setNull(pricelist[i]['harga_jual']
                                              .toString() +
                                          ' DIAMOND'),
                                      12.0,
                                      FontWeight.normal),
                                  ...
                                  namaField(
                                      'Total Pembayaran',
                                      setNull(
                                        pricelist[i]['harga_jual'].toString() +
                                            ' DIAMOND',
                                      ),
                                      12.0,
                                      FontWeight.bold),
